        ...
        >
            <Box py={12} >
                <Stack direction="row" spacing="2" >
                    ...
                    <Box>
                        <Text fontSize={{ base: '2xl', lg:'4xl'}}> localhost:300/api-pay</Text>
                        <Text fontSize={{ base: 'sm', lg:'lg'}}> Up - Refreshing every 30 seconds...</Text>
                    </Box>
                </Stack>
            </Box>
            <Box pl={4} >

            <Stack direction={{ base: 'column', lg:'row'}} spacing={{ base: '2', lg:'8'}}>
                <HStack _hover={{ cursor: 'pointer', bg: 'gray.400' }}>
                    <FiAlertTriangle/>
                    <Text >Send a test alert</Text>
                </HStack>
                <HStack _hover={{ cursor: 'pointer', bg: 'gray.400' }}>
                    <FiBell/>
                    <Text >Incidents</Text>
          ...
          <SimpleGrid py="4" minChildWidth="240px" spacing="40px">
            <Skeleton isLoaded={!loading}>
                <Box px={4} py={4}  borderRadius="lg" boxShadow="md" height="120px">
                    <Text fontSize="lg">
                        Monitor is up for
                    </Text>
